...
import { ApplicantRepository } from "@/modules/recruitment/modules/applicant/data/repository/ApplicantRepository"
import { VacancyBloc } from "@/modules/recruitment/modules/vacancy/presentation/bloc"
import { ApplicantBloc } from "@/modules/recruitment/modules/applicant/presentation/bloc"
import { CreateNewApplicantUseCase } from "@/modules/recruitment/modules/applicant/domain/application/use-cases/CreateNewApplicant"
import { GetApplicantsByVacancyIdUseCase } from "@/modules/recruitment/modules/applicant/domain/application/use-cases/GetApplicantsByVacancyId"
import { ChangeApplicantStatusUseCase } from "@/modules/recruitment/modules/applicant/domain/application/use-cases/ChangeApplicantStatus"
